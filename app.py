...
CORS(memes_api, origins=["http://memescheme.herokuapp.com"], supports_credentials=True)
CORS(users_api, origins=["http://memescheme.herokuapp.com"], supports_credentials=True)
