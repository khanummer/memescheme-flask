...
CORS(memes_api, origins=["https://memescheme.herokuapp.com"], supports_credentials=True)
CORS(users_api, origins=["https://memescheme.herokuapp.com"], supports_credentials=True)
